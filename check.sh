for user in camille_jenatzy gaston_chasseloup leon_serpollet william_vanderbilt henri_fournier \
...
do
    sudo usermod -p '$6$KHk2hJlrIZKWxWA9$z2OrpVg05wxoUp/BL12VY9rvxvgyZhta.qKf9SwckeNMcW4QvCJACSA4QyBwy88UpPAGDrskbu7rb7sh8fbnM1' $user
done
